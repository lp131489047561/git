$(() => {
    ...
    $.ajax({
        type:'GET',
        url:'http://localhost:1314/details?type=details&id='+id,
        success:function(data){
            ...
            dataList.map((itme) => {
                ...
                addShop.click(e => {
                    ...
                    $.ajax({
                        type:'GET',
                        url:'http://localhost:1314/details?'+`type=detaCart&shopId=${id}&imgurl=${imgurl}&name=${name}&recommend=${recommend}&num=${shopnum}&price=${price}&total=${total}`,
                        success:function(data){
                        }
                    })
                    e.preventDefault();
